...
public class API {
  public static void main(String[] args) {
    ...
    CrewMember director =
        crewMemberList.stream().filter(e -> e.job.equals("Director")).findFirst().orElse(null);

    Mapper mapper = DozerBeanMapperBuilder.buildDefault();


    model.orm.CrewMember crewMember = mapper.map(director, model.orm.CrewMember.class);
    System.out.println(crewMember.getJob());
  }
}
