...
public class testMain {
  ...
  public static void main(String[] args) {
    ...
    Call<Result> result =
        apiInterface.response(3, "search", "909af28891cff6bfe9ea2fea81fc5426", "Oldboy", 2003);
    ...
    try {
      ...
      //           statement.executeUpdate("UPDATE Movie_List SET Rating = " +
      // firstMovie.getVoteAverage() + ", Overview = '" + firstMovie.getOverview() + "' WHERE ID =
      // 2292");
